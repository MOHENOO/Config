# Generated by Powerlevel10k configuration wizard on 2020-04-28 at 11:15 CST.
...
() {
  ...
  function prompt_spotify () {
      ...
      if [ playing = "playing" ]; then
          ...
          p10k segment -i '' -f green -t "$artist - $track"
      fi
  }
  typeset -g POWERLEVEL9K_SPOTIFY_CONTENT_EXPANSION='${spotify_on+$P9K_CONTENT}'
  typeset -g POWERLEVEL9K_SPOTIFY_VISUAL_IDENTIFIER_EXPANSION='${spotify_on+$P9K_VISUAL_IDENTIFIER}'
